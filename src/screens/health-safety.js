        ...
        <div className="row col-sm-9">
          ...
          <form>
            <div className="row col-sm-12">
              ...
              <p>
                A full copy of our Health and Safety Policy is available for you
              ...
              <div className="row col-sm-12">
                ...
                <ol type="a">
                  <li>
                    Co-operating with your manager to achieve a healthy and safe
                    workplace.
                  </li>
                  <li>
                  ...
                  <li>
                    Not interfering with, or misusing, anything provided in the
              ...
              <div className="row col-sm-12">
                ...
                <ol type="a">
                  ...
                  <li>
                    Wearing the personal protective equipment (PPE) that you are
                    provided with.
                  </li>
                  <li>
              ...
              <p>
                ...
                be reported via accident reporting form, therefore please ensure
                you notify any accidents that you have, no matter how minor, to
                your manager.
              </p>
              <h6 className="font-weight-bold">
              ...
              <div className="row mt-2">
                ...
                <p className="col-sm-12">
                  When all 3 components of the fire triangle are present, a fire
                  can start.
                </p>
              ...
              <div className="row col-12">
                ...
                <div className="row">
                  <div className="col-12">
                    <p>
                      Every six months, as part of the practice fire drill, you
                      will receive refresher fire training, covering:
                    </p>
                  </div>
                  <div className="col-12">
                    <ol type="a">
                  ...
                  <div className="col-12">
                    <p>
                      ...
                      enough, the firefighting equipment is to hand, and they do
                  ...
                  <div className="col-12">
                    ...
                    <div className="row">
                      <div className="col-9">
                        <ol type="a">
                          ...
                          <li>
                            Where possible close windows and always close doors
                            behind you.
                          </li>
                    ...
                    <p>
                      <strong>Remember</strong> it is very dangerous to use the
                      wrong firefighting equipment and tackle a blaze that you
                      cannot cope with -
                      <strong>
