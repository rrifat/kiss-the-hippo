...
export default function Riddor({navigate}) {
  const {
    page,
    setPage,
    userData: {user},
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="col-sm-9 mb-1">
              ...
              <p>
                ...
                requires employers, and other people in control of work
              ...
              <ul>
                ...
                <li>
                  {' '}
                  certain ‘dangerous occurrences’ (incidents with the potential
                  to cause harm).
                </li>
              </ul>
            </div>
            ...
            <div className="col-sm-9 mb-3">
              <strong>
                <p>
                  ...
                  <span className="text-uppercase">RIDDOR</span> keeps records
                  of-
                </p>
                <ul className="list-unstyled">
                  {options['riddorQ1'].map((option, index) => (
                    <li key={index}>
                      <input
                        type="radio"
                        name="riddorQ1"
            ...
            <div className="col-sm-9 pb-2">
              ...
              <p>
                ...
                provide advice about how to avoid work-related deaths, injuries,
                ill health and accidental loss.
              </p>
            </div>
            <div className="col-sm-9 mb-3">
              <strong>
                ...
                <ul className="list-unstyled">
                  {options['riddorQ2'].map((option, index) => (
                    <li key={index}>
                      <input
                        type="radio"
                        name="riddorQ2"
            ...
            <div className="col-sm-9">
              ...
              <p>
                Not all accidents need to be reported, a RIDDOR report is
                required only when:
              </p>
              <ul className="list-unstyled">
              ...
              <p>
                ...
                work-related, the key issues to consider are whether the
                accident was related to:
              </p>
              <ul className="list-unstyled">
                <li className="pl-4">
            ...
            <div className="col-sm-9 mb-3">
              <strong>
                ...
                <ul className="list-unstyled">
                  {options['riddorQ3'].map((option, index) => (
                    <li key={index}>
                      <input
                        type="radio"
                        name="riddorQ3"
            ...
            <div className="col-sm-9 mb-3">
              ...
              <ul className="list-unstyled">
                ...
                <li className="pl-4">
                  -serious burns (covering more than 10% of the body, or
                  damaging the eyes,
                </li>
                <li className="pl-4">
            ...
            <div className="col-sm-9 font-weight-bold mb-5">
              <p>Please confirm which statement is True-</p>
              <ul className="list-unstyled">
                {options['riddorQ4'].map((option, index) => (
                  <li key={index}>
                    <input
                      type="radio"
                      name="riddorQ4"
            ...
            <div className="col-sm-9">
              ...
              <div className="form-group">
                <label className="form-check-label">
                  <b>
                    Is it mandatory to report a worker away from work or unable
                    to perform their normal work duties for more than seven
                    consecutive days
                  </b>
                </label>
                {['Yes', 'No'].map((value, index) => (
                  <div className="form-check form-check-inline" key={index}>
                    <input
                      ...
                      ref={register({
                        validate: value =>
                          value === 'Yes' || 'Your answers is not correct!',
                      })}
                    />
                    <label className="form-check-label">
                      <b>{value}</b>
            ...
            <div className="col-sm-9 mb-3">
              ...
              <p>
                ...
                who are not at work must be reported if a person is injured and
                is taken from the scene of the accident to hospital for
                treatment to that injury. There is no requirement to establish
                what hospital treatment was actually provided, and no need to
                report incidents where people are taken to hospital purely as a
              ...
              <div className="form-group">
                <label className="form-check-label">
                  <b>
                    You must report -work-related accidents involving members of
                    the public or people who are not at work.
                  </b>
                </label>
            ...
            <div className="col-sm-9 mb-3">
              ...
              <p>
                ...
                certain occupational diseases, where these are likely to have
                been caused or made worse by their work. These diseases include
                (regulations 8 and 9):
              </p>
              <ul className="list-unstyled">
            ...
            <div className="col-sm-9 mb-3">
              <strong>
                ...
                <ul className="list-unstyled">
                  {options['riddorQ7'].map((option, index) => (
                    <li key={index}>
                      <input
                        type="radio"
                        name="riddorQ7"
            ...
            <div className="col-sm-9 mb-3">
              ...
              <p>
                ...
                (incidents with the potential to cause harm.) Not all such
                events require reporting. There are 27 categories of dangerous
              ...
              <ul className="list-unstyled">
                ...
                <li className="pl-4">
                  -explosions or fires causing work to be stopped for more than
                  24 hours.
                </li>
              </ul>
              <div className="form-group">
                <label className="form-check-label">
                  <b>There are 72 categories of dangerous occurrences.</b>
                </label>
                {['True', 'False'].map((value, index) => (
                  <div className="form-check form-check-inline" key={index}>
                    <input
            ...
            <div className="col-sm-9 mb-3">
              ...
              <p>
                <b>Records</b> of incidents covered by RIDDOR are also
                important. They ensure that you collect sufficient information
                to allow you to properly manage health and safety risks. This
                information is a valuable management tool that can be used as an
                aid to risk assessment, helping to develop solutions to
                potential risks. In this way, records also help to prevent
              ...
              <ul className="list-unstyled">
                ...
                <li className="pl-4">
                  -any other occupational accident causing injuries that result
                  in a worker being away from work or{' '}
                  <b> incapacitated for more than three consecutive days</b>{' '}
                  (not counting the day of the accident but including any
                  weekends or other rest days).You do not have to report
                  over-three-day injuries, unless the incapacitation period goes
                  on to exceed seven days.
                </li>
              </ul>
              <p>
            ...
            <div className="col-sm-9 mb-3">
              ...
              <div className="form-group">
                <label className="form-check-label">
                  <b>
                    You should only keep records of accident, occupational
                    disease or dangerous occurrence which lead to admittance in
                    hospital.
                  </b>
                </label>
                {['True', 'False'].map((value, index) => (
            ...
            <div className="col-sm-9">
              ...
              <p>
                HSE has an out-of-hours duty officer. Circumstances where HSE
                may need to respond out of hours include:
              </p>
              <ul className="list-unstyled">
                <li className="pl-4">
                  -a work-related death or situation where there is a strong
                  likelihood of death following an incident at, or connected
                  with, work;
                </li>
                <li className="pl-4">
                  -a serious accident at a workplace so that HSE can gather
                  details of physical evidence that would be lost with time; and
                  following a major incident at a workplace where the severity
                  of the incident, or the degree of public concern, requires an
              ...
              <p>
                ...
                working hours, you should complete an online form at{' '}
